	...
	<div class="container">
		...
		<form class="form-horizontal">
			...
			<div class="control-group">	
				...
				<div class="controls">
				<input id="entrytime" type="text" readonly="readonly" name="employee.reachSchoolDate"/>
				</div>
			</div>
			...
			<div class="control-group">	
				...
				<div class="controls">
				<input id="position" type="text"  readonly="readonly" name="employee.hireWork"/>
				</div>
			</div>
			...
			<div class="control-group">	
				...
				<div class="controls">
				<input id="poslabel" type="text" readonly="readonly" name="employee.workLevel"/>
				</div>
			</div>
			...
			<div class="control-group">	
				...
				<div class="controls">
				<input id="assumetime" type="text"  readonly="readonly" name="employee.startWorkDate"/>
				</div>
			</div>
			...
			<div class="control-group">	
				...
				<div class="controls">
				<input id="originaltitle" type="text" readonly="readonly" name="employee.hireTitle" />
				</div>
			</div>
			...
			<div class="control-group">	
				...
				<div class="controls">
				<input id="originallabel" type="text" readonly="readonly" name="employee.titleLevel" />
				</div>
			</div>
			...
			<div class="control-group">	
				...
				<div class="controls">
				<input id="originaltime" type="text" readonly="readonly" name="employee.hireDate" />
				</div>
			</div>
			...
			<div class="form-actions">
				...
				<a href="overdeal.html" target="mainFrame"><input type="button" name="btncomp" value="完成" /></a>
			</div>
			</fieldset>
		</form>
	</div>
