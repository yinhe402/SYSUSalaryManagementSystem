...
>>>>>>> 4e2ddd8e9d1ce902ca74eb0a165dae46a86bedda
		$(function(){ 
		    $("#date_1").datepicker({
	    		format: 'yyyy-mm-dd',
	    	}); 
				...
				<tbody>
					<s:iterator value="#session.salaryList" id="salary">
						<tr>
							...
							<td><s:property value="#salary.eid" />
							</td>
							<td><s:property value="#salary.positionSalary" />
							</td>
							<td><s:property value="#salary.levelSalary" />
							</td>
							<td><s:property value="#salary.totleSalary" />
							</td>
						</tr>
					</s:iterator>
					<tr>
						<td>总额</td>
						<td></td>
						<td><s:property value="#session.totalPosition" />
						</td>
						<td><s:property value="#session.totalLevel" />
						</td>
						<td><s:property value="#session.totalAmount" />
						</td>
					</tr>
					...
					<tr>
						<td>平均额</td>
						<td></td>
						<td><s:property value="#session.averagePosition" />
						</td>
						<td><s:property value="#session.averageLevel" />
						</td>
						<td><s:property value="#session.averageAmount" />
						</td>
					</tr>
				</tbody>
			</table>
